...
export default function LoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    // Full reload so middleware picks up session cookie
      ...
      <div className="flex-1 bg-background px-6 pt-6 pb-8 -mt-4 rounded-t-3xl">
        ...
        <div className="flex flex-col gap-2.5">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white border border-border rounded-button py-3.5 text-sm font-display font-semibold text-text-primary hover:bg-background active:scale-[0.98] transition-all shadow-sm"
          >
