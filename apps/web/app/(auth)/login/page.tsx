          ...
          <div className="mt-10 bg-white/10 backdrop-blur border border-white/20 rounded-2xl p-5 text-left max-w-xs mx-auto">
            <div className="flex items-center gap-2 mb-3">
              <div className="flex gap-0.5">
                {[1,2,3,4,5].map(i => (
                  <svg key={i} aria-hidden="true" width="13" height="13" viewBox="0 0 24 24" fill="#FFD60A"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
                ))}
              </div>
            ...
            <div className="flex items-center gap-2 mt-4">
              <div aria-hidden="true" className="w-7 h-7 rounded-full bg-white/20 flex items-center justify-center shrink-0">
